    ...
    return (
        ...
        >
            ...
            <div className={`flex h-full ${isFeatured ? (isVertical ? "flex-col md:flex-row" : "flex-col") : "flex-col"}`}>
                ...
                <div className={`flex flex-col flex-grow ${isFeatured ? "p-5 sm:p-7" : "p-4 sm:p-5"} ${isVertical && isFeatured ? "md:justify-center" : ""} relative`}>
                        ...
                        <div className="flex items-center gap-2 ml-auto z-20">
                            {project.telegram && (
                                <a
                                    ...
                                    className="p-1.5 rounded-full bg-[#24A1DE]/10 text-[#24A1DE] hover:bg-[#24A1DE] hover:text-white transition-all duration-300 border border-[#24A1DE]/20"
                            ...
                            {project.github && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="p-1.5 rounded-full text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors border border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600"
